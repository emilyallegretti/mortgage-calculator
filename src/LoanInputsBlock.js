    ...
    return (
        <>
            ...
            <form onSubmit={onGenerateClicked}>
                ...
                <input type="number" min="1" id="loan_length" name="Length of Loan" required></input>

                <label htmlFor="interest_rate">Annual Interest Rate</label>
                <input type="number"  min=".0001" step=".0001" id="interest_rate" name="Interest Rate" required></input>
